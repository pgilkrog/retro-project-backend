...
const corsOptions = {
    origin: ["http://localhost:5173", "https://pawgilkrog.dk", "http://127.0.0.1:5173"],
    credentials: true
}
...
router.use('/api/assets/spaceshooter', express.static(path.join(__dirname, '../src/assets/spaceshooter')))
